...
public class UnitTest1
{
    ...
    public void NodeClassTest()
    {
        ...
        var node1 = new TreeNode<SampleClass>(obj1);
        var node2 = new TreeNode<SampleClass>(obj2);
        node1.AddNode(node2);
        ...
        Assert.True(node1.Equals(new TreeNode<SampleClass>(obj1)));
        Assert.False(node1.Equals(new TreeNode<SampleClass>(new SampleClass("New Obj"))));
    }
    ...
    public void INodeInterfaceTest_GetSetParent()
    {
        ...
        var node3 = new TreeNode<SampleClass>(obj3);
        // кладем node3 в node2
        node2.AddNode(node3);
        // кладем new node(obj4) в node1
        node1.AddNode(new TreeNode<SampleClass>(obj4));
